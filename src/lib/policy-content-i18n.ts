    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Herinneringen: foto’s/GIF’s die je uploadt en videolinks die je insluit, bijschriften, evenement/stad/jaar, een optionele weergavenaam, een link naar sociale media en een land (weergegeven als vlag). Worden onmiddellijk openbaar gepubliceerd; kunnen na beoordeling of na een melding worden verborgen of verwijderd.",
            "Account (optioneel): account-ID (standaard anoniem), weergavenaam, een optionele Instagram-gebruikersnaam (die wordt opgeslagen zodat deze automatisch wordt ingevuld bij het uploaden), land van herkomst, festivalbezoeklogboek („Passport”) en — alleen als je ervoor kiest om dit te koppelen — je e-mailadres.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Erinnerungen: Fotos/GIFs, die Sie hochladen, sowie eingebettete Videolinks, Bildunterschriften, Veranstaltung/Stadt/Jahr, ein optionaler Anzeigename, ein Link zu sozialen Netzwerken und ein Land (als Flagge angezeigt). Werden sofort öffentlich veröffentlicht; können nach Überprüfung oder aufgrund einer Meldung ausgeblendet oder entfernt werden.",
            "Konto (optional): Konto-ID (standardmäßig anonym), Anzeigename, ein optionaler Instagram-Nutzername (wird gespeichert, damit er bei Ihren Uploads automatisch ausgefüllt wird), Heimatland, Festivalbesuchsprotokoll („Passport“) und – nur, wenn Sie sich dafür entscheiden, sie zu verknüpfen – Ihre E-Mail-Adresse.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Recuerdos: fotos o GIF que subas y enlaces a vídeos que incrustes, pies de foto, evento, ciudad y año, un nombre de usuario opcional, un enlace a redes sociales y un país (mostrado como bandera). Se publican de forma pública de inmediato; pueden ocultarse o eliminarse tras una revisión o una denuncia.",
            "Cuenta (opcional): ID de cuenta (anónima por defecto), nombre de usuario, nombre de usuario de Instagram opcional (que se guarda para que se rellene automáticamente al subir contenido), país de origen, registro de asistencia a festivales («Passport») y —solo si decides vincularla— tu dirección de correo electrónico.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Souvenirs : photos/GIF que vous publiez et liens vers des vidéos que vous intégrez, légendes, événement/ville/année, nom d'affichage facultatif, lien vers les réseaux sociaux et pays (affiché sous forme de drapeau). Publiés immédiatement ; peuvent être masqués ou supprimés à la suite d'un examen ou d'un signalement.",
            "Compte (facultatif) : identifiant du compte (anonyme par défaut), nom d'affichage, pseudo Instagram facultatif (enregistré pour que vos publications puissent le remplir automatiquement), pays d'origine, historique de participation aux festivals (« Passport ») et — uniquement si vous choisissez de l'associer — votre adresse e-mail.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Ricordi: foto/GIF caricate e link a video incorporati, didascalie, evento/città/anno, un nome visualizzato facoltativo, un link ai social e un paese (mostrato come bandiera). Pubblicati immediatamente in modo pubblico; possono essere nascosti o rimossi a seguito di revisione o segnalazione.",
            "Account (facoltativo): ID account (anonimo per impostazione predefinita), nome visualizzato, nome utente Instagram facoltativo (salvato in modo che possa essere precompilato nei tuoi caricamenti), paese di residenza, registro delle partecipazioni ai festival (“Passport”) e — solo se scegli di collegarlo — il tuo indirizzo e-mail.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Memórias: fotografias/GIFs que carregas e links de vídeo que incorporas, legendas, evento/cidade/ano, um nome de exibição opcional, um link para redes sociais e um país (apresentado como bandeira). Publicadas publicamente de imediato; podem ser ocultadas ou removidas após revisão ou denúncia.",
            "Conta (opcional): ID da conta (anónima por predefinição), nome de exibição, um nome de utilizador opcional do Instagram (guardado para que as suas publicações possam preenchê-lo automaticamente), país de origem, registo de participação em festivais («Passaporte») e — apenas se optar por associá-lo — o seu endereço de e-mail.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          "heading": "2. 収集する情報",
          "paragraphs": [
            "思い出：アップロードした写真やGIF、埋め込んだ動画リンク、キャプション、イベント・都市・年、任意の表示名、ソーシャルメディアへのリンク、および国（国旗で表示）。公開されるとすぐに誰でも閲覧可能になりますが、審査や通報により非表示にされたり削除されたりする場合があります。",
            "アカウント（任意）：アカウントID（デフォルトでは匿名）、表示名、任意のInstagramユーザー名（アップロード時に自動入力されるよう保存されます）、居住国、フェスティバル参加履歴（「パスポート」）、および（連携を選択した場合のみ）メールアドレス。",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          "heading": "2. 수집하는 정보",
          "paragraphs": [
            "메모리: 사용자가 업로드한 사진/GIF, 삽입한 동영상 링크, 캡션, 이벤트/도시/연도, 선택 사항인 표시 이름, 소셜 링크, 국가(국기로 표시). 게시 즉시 공개되며, 검토 또는 신고를 통해 숨겨지거나 삭제될 수 있습니다.",
            "계정 (선택 사항): 계정 ID(기본적으로 익명), 표시 이름, 선택 사항인 인스타그램 핸들(업로드 시 자동으로 입력되도록 저장됨), 거주 국가, 축제 참가 기록(“Passport”), 그리고 — 연동을 선택한 경우에만 — 이메일 주소.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Wspomnienia: zamieszczane przez Ciebie zdjęcia/GIF-y oraz osadzone linki do filmów, opisy, wydarzenie/miasto/rok, opcjonalna nazwa wyświetlana, link do profilu w mediach społecznościowych oraz kraj (wyświetlany jako flaga). Publikowane natychmiast publicznie; mogą zostać ukryte lub usunięte w wyniku weryfikacji lub zgłoszenia.",
            "Konto (opcjonalnie): identyfikator konta (domyślnie anonimowy), nazwa wyświetlana, opcjonalna nazwa użytkownika na Instagramie (zapisywana w celu automatycznego wypełniania jej podczas przesyłania treści), kraj pochodzenia, rejestr uczestnictwa w festiwalach („Passport”) oraz — wyłącznie w przypadku, gdy zdecydujesz się go powiązać — Twój adres e-mail.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Minnen: foton/GIF-bilder som du laddar upp och videolänkar som du bäddar in, bildtexter, evenemang/stad/år, ett valfritt visningsnamn, en länk till sociala medier och ett land (visas som en flagga). Publiceras omedelbart för alla; kan döljas eller tas bort efter granskning eller anmälan.",
            "Konto (valfritt): konto-ID (anonymt som standard), visningsnamn, ett valfritt Instagram-användarnamn (sparas så att det kan fyllas i automatiskt vid uppladdningar), hemland, logg över festivaldeltagande (”Passport”) samt – endast om du väljer att koppla den – din e-postadress.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Anılar: Yüklediğiniz fotoğraflar/GIF’ler ve eklediğiniz video bağlantıları, açıklamalar, etkinlik/şehir/yıl, isteğe bağlı bir görüntüleme adı, sosyal medya bağlantısı ve bir ülke (bayrak olarak gösterilir). Hemen herkese açık olarak yayınlanır; inceleme veya bildirim üzerine gizlenebilir veya kaldırılabilir.",
            "Hesap (isteğe bağlı): hesap kimliği (varsayılan olarak anonim), görüntüleme adı, isteğe bağlı bir Instagram kullanıcı adı (yüklemelerinizde bu adın otomatik olarak doldurulması için kaydedilir), ikamet ettiğiniz ülke, festival katılım kaydı (“Passport”) ve — yalnızca bunu bağlamayı seçerseniz — e-posta adresiniz.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          "heading": "2. 我们收集的信息",
          "paragraphs": [
            "回忆：您上传的照片/GIF动图、嵌入的视频链接、配文、活动/城市/年份，以及可选的显示名称、社交媒体链接和国家/地区（以国旗显示）。内容将立即公开发布；经审核或举报后，可能会被隐藏或删除。",
            "账户（可选）：账户 ID（默认匿名）、显示名称、可选的 Instagram 用户名（会保存下来以便上传时自动填充）、所在国家/地区、音乐节参与记录（“Passport”），以及——仅当您选择关联时——您的电子邮件地址。",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          "heading": "2. 我們收集的資訊",
          "paragraphs": [
            "回憶：您上傳的照片／GIF 動圖、嵌入的影片連結、配文、活動／城市／年份，以及選填的顯示名稱、社群媒體連結與國家／地區（以國旗顯示）。內容會立即公開發佈；經審核或檢舉後，可能會被隱藏或刪除。",
            "帳號（選填）：帳號 ID（預設匿名）、顯示名稱、選填的 Instagram 使用者名稱（會儲存下來，以便上傳時自動填入）、所在國家／地區、音樂節參與紀錄（「Passport」），以及——僅當您選擇連結時——您的電子郵件地址。",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Memory: foto/GIF yang Anda unggah dan tautan video yang Anda sematkan, keterangan, acara/kota/tahun, nama tampilan (opsional), tautan media sosial, serta negara (ditampilkan sebagai bendera). Dipublikasikan secara terbuka seketika; dapat disembunyikan atau dihapus setelah ditinjau atau dilaporkan.",
            "Akun (opsional): ID akun (secara default bersifat anonim), nama tampilan, nama pengguna Instagram (opsional; disimpan agar dapat diisi otomatis saat Anda mengunggah), negara asal, riwayat kehadiran festival (“Passport”), dan — hanya jika Anda memilih untuk menghubungkannya — alamat email Anda.",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "ความทรงจำ: รูปภาพ/GIF ที่คุณอัปโหลดและลิงก์วิดีโอที่คุณฝังไว้, คำบรรยาย, เหตุการณ์/เมือง/ปี, ชื่อแสดง (เลือกได้) ลิงก์โซเชียลมีเดีย และประเทศ (แสดงเป็นธง). จะถูกเผยแพร่ให้สาธารณะทันที; อาจถูกซ่อนหรือลบออกหลังการตรวจสอบหรือการรายงาน",
            "บัญชี (ไม่บังคับ): ID บัญชี (ตั้งค่าเป็นแบบไม่ระบุตัวตนตามค่าเริ่มต้น), ชื่อที่แสดง, ชื่อผู้ใช้ Instagram (ไม่บังคับ; จะถูกบันทึกไว้เพื่อให้ระบบสามารถกรอกอัตโนมัติเมื่ออัปโหลด), ประเทศที่พำนัก, บันทึกการเข้าร่วมเทศกาล (\"Passport\"), และ — เฉพาะเมื่อคุณเลือกที่จะเชื่อมโยง — ที่อยู่อีเมลของคุณ",
    ...
    "privacy": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Ký ức: ảnh/GIF mà bạn tải lên và các liên kết video mà bạn nhúng, chú thích, sự kiện/thành phố/năm, tên hiển thị (tùy chọn), liên kết mạng xã hội và quốc gia (hiển thị dưới dạng cờ). Được đăng công khai ngay lập tức; có thể bị ẩn hoặc xóa sau khi được kiểm duyệt hoặc khi có báo cáo.",
            "Tài khoản (tùy chọn): ID tài khoản (mặc định là ẩn danh), tên hiển thị, tên người dùng Instagram (tùy chọn, được lưu lại để tự động điền khi bạn tải lên), quốc gia cư trú, nhật ký tham dự lễ hội (“Passport”), và — chỉ khi bạn chọn liên kết — địa chỉ email của bạn.",
