    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Account (optional): account ID (anonymous by default), display name, an optional Instagram handle (saved so your uploads can pre-fill it), home country, festival attendance log ("Passport"), and — only if you choose to link it — your email address.',
