    ...
    <header className="sticky top-0 z-20 border-b border-line bg-black/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-3 py-3 sm:gap-3 sm:px-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <Link
            href="/upload"
            className="whitespace-nowrap rounded-full bg-orange px-3 py-2 text-[13px] font-medium text-black transition-opacity hover:opacity-90 max-[374px]:text-xs sm:px-4 sm:text-sm"
          >
            {t('cta')}
          </Link>
        </div>
